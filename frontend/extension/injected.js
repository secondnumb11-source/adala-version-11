...
(function () {
  ...
  function shouldCapture(url, contentType, body) {
    ...
    return /json|text|javascript/i.test(contentType || "") || containsBusinessWords(body) ||
      /(lawsuit|case|session|hearing|agency|wekal|poa|execution|request|judgment|notice|document)/i.test(target);
  }

      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <Card className="card-3d border-none p-6">
          <div className="flex items-start justify-between mb-4">
            <div>
              <h3 className="font-bold text-lg">إضافة متصفح Chrome v4.6</h3>
              <p className="text-xs text-muted-foreground mt-1">إصدار 4.6: واجهة مبسّطة بزر واحد "مزامنة جميع البيانات تلقائياً" (يجمع البوت السريع + المعمّق + سحب الصفحة) + إصلاح سحب الأحكام (context-aware يلتقط كل صفوف الجداول في تبويب الأحكام).</p>
            </div>
          ...
          <Button onClick={handleDownload} className="btn-gold gap-2 w-full" data-testid="download-extension-btn">
            <Download className="h-4 w-4" /> تنزيل الإضافة v4.6 (ZIP)
          </Button>
        </Card>

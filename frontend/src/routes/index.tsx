...
import {
  ...
  Receipt, Library, Network, Crown, ChevronDown,
} from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 -z-10 pointer-events-none" aria-hidden="true">
        ...
        <div className="absolute bottom-0 left-1/5 h-[500px] w-[500px] rounded-full bg-primary/25 blur-[140px] orb-drift" style={{ animationDelay: "3s" }} />
      ...
      <div className="container mx-auto grid items-center gap-16 px-4 lg:grid-cols-2">
        <div className="text-center lg:text-right scroll-reveal">
          ...
          >
            ...
            <span aria-hidden="true" className="mt-4 flex items-center justify-center lg:justify-end gap-3 text-3xl sm:text-4xl lg:text-6xl font-extrabold text-gradient-premium">
              <span aria-hidden className="hidden sm:inline-block h-px w-12 bg-gradient-to-l from-gold to-transparent" />
          ...
          <p className="mt-8 text-xl lg:text-2xl text-high-contrast leading-relaxed font-semibold">
            ...
            {" "}<strong className="text-primary font-black">بوابة ناجز</strong>{" "}
            لمزامنة الجلسات، ونوفر صياغة اللوائح بالذكاء الاصطناعي، فواتير
            {" "}<strong className="text-primary font-black">ZATCA</strong>{" "}
            وإشعارات{" "}<strong className="text-primary font-black">واتساب</strong>{" "}
        ...
        <div className="relative scroll-reveal" style={{ animationDelay: "0.2s" }}>
              ...
              <div className="rounded-[1.5rem] bg-gradient-to-br from-primary via-primary to-[oklch(0.32_0.1_270)] p-8 text-primary-foreground relative overflow-hidden">
                ...
                <div className="relative mt-6 space-y-4 text-base pop-z">
                  <div className="rounded-xl bg-white/10 p-5 ring-1 ring-white/15 shadow-inner backdrop-blur-sm">
                    ...
                    <p className="leading-relaxed text-white/95 font-semibold">صغ لي لائحة اعتراضية على حكم في نزاع توريد تجاري...</p>
                  </div>
                  <div className="rounded-xl bg-gradient-to-bl from-gold/25 to-gold/15 p-5 border-2 border-gold/50 shadow-[0_8px_32px_-8px] shadow-gold/50 backdrop-blur-sm">
                    ...
                    <p className="leading-relaxed text-white/95 font-semibold">✓ تم تشخيص الحكم ومطابقته بمواد نظام المحاكم التجارية السعودي.</p>
                    <p className="mt-3 leading-relaxed text-white/95 font-semibold">
                      🚀 <strong className="text-gold font-black">الدفع المقترح:</strong> عدم مطابقة الخدمة للمادة السابعة من العقد.
                    </p>
                  </div>
          ...
          <div className="absolute -bottom-6 -left-6 hidden md:block scroll-reveal" style={{ animationDelay: "0.4s" }}>
            <Tilt3D max={25}>
          ...
          <div className="absolute -top-6 -right-6 hidden md:block scroll-reveal" style={{ animationDelay: "0.6s" }}>
            <Tilt3D max={25}>
              <div className="card-glass-3d p-4 bg-card flex items-center gap-3 rounded-2xl">
  ...
  return (
    <section className="border-y-2 border-gold/30 bg-gradient-to-l from-primary/10 to-gold/10 py-12 section-premium-2">
      <div className="container mx-auto grid grid-cols-2 gap-6 px-4 md:grid-cols-4">
        {stats.map((s, i) => (
          <Tilt3D key={s.l} max={10} className="rounded-2xl scroll-reveal" style={{ animationDelay: `${i * 0.1}s` }}>
            <div className="card-glass-3d p-6 text-center">
              <div className="text-4xl md:text-5xl font-black text-gradient-premium text-3d-emboss">{s.v}</div>
    ...
    <section id="features" className="py-24 section-premium-1">
      <div className="container mx-auto px-4">
        ...
        <div className="mt-16 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {FEATURES.map((f, i) => (
            <Tilt3D key={f.t} max={12} className="rounded-2xl scroll-reveal" style={{ animationDelay: `${i * 0.08}s` }}>
              <div className="card-glass-3d group p-8 h-full">
                ...
                <p className="mt-3 text-base text-high-contrast leading-relaxed font-semibold">{f.d}</p>
...
function SectionHeader({ eyebrow, title, subtitle }: { eyebrow: string; title: string; subtitle: string }) {
  return (
    <div className="mx-auto max-w-3xl text-center scroll-reveal">
      ...
      <h2 className="mt-4 text-4xl md:text-6xl font-black text-gradient-premium leading-tight text-ultra-high-contrast">{title}</h2>
...
function CompareRow({ type, title, text }: { type: "good" | "bad"; title: string; text: string }) {
  return (
    <div className={`rounded-xl border-r-4 p-5 ${type === "good" ? "border-success bg-success/10" : "border-destructive/60 bg-destructive/5"}`}>
    ...
    <section id="comparison" className="py-24 section-premium-1">
      <div className="container mx-auto px-4">
        ...
        <div className="card-glass-3d mt-16 overflow-hidden p-0 scroll-reveal">
          ...
          {rows.map((r, i) => (
            <div key={r.f} className={`grid grid-cols-12 items-center gap-2 border-t-2 border-border/50 px-8 py-6 text-base transition-all hover:bg-accent/40 hover:scale-[1.01] ${i % 2 ? "bg-muted/20" : ""}`}>
              ...
              <div className="col-span-3 text-center">
                <span className="inline-flex items-center gap-2 rounded-full bg-success/15 px-4 py-1.5 text-success font-black text-sm ring-2 ring-success/30">
                  <CheckCircle2 className="h-4 w-4" />{r.us}
                </span>
              </div>
              <div className="col-span-3 text-center text-medium-contrast text-sm font-semibold">
                <span className="inline-flex items-center gap-2"><XCircle className="h-4 w-4 text-destructive" />{r.them}</span>
              </div>
            </div>
          ))}
        </div>
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="card-glass-3d mt-14 grid gap-10 p-10 md:grid-cols-2 scroll-reveal">
          <div className="space-y-8">
            <div>
              <label className="text-base font-black text-ultra-high-contrast">عدد القضايا النشطة: <span className="text-gold font-black text-3d-emboss">{cases}</span></label>
            ...
            <div>
              <label className="text-base font-black text-ultra-high-contrast">عدد المستشارين بفريقك: <span className="text-gold font-black text-3d-emboss">{team}</span></label>
    ...
    <section className="py-24 section-premium-1">
      <div className="container mx-auto grid items-center gap-14 px-4 lg:grid-cols-2">
        <div className="scroll-reveal">
          ...
          <h2 className="mt-4 text-4xl md:text-5xl font-black text-gradient-premium">تنبيه العملاء فوراً عبر واتساب</h2>
          ...
          <ul className="mt-7 space-y-4">
            {[
              ...
              <li key={t} className="flex items-center gap-4 text-base font-bold text-high-contrast">
                <CheckCircle2 className="h-6 w-6 text-success icon-3d-hover" />{t}
              </li>
            ))}
          </ul>
        </div>
          ...
          <div className="mx-auto w-full max-w-sm">
            <div className="card-glass-3d p-5 bg-gradient-to-b from-[#075E54] to-[#128C7E] text-white">
              <div className="flex items-center gap-4 border-b-2 border-white/30 pb-4">
                <div className="grid h-12 w-12 place-items-center rounded-full bg-white/25 icon-3d-hover ring-2 ring-white/40"><Scale className="h-6 w-6" /></div>
                <div>
              ...
              <div className="mt-5 space-y-3">
                <div className="rounded-2xl rounded-tl-sm bg-white/20 p-4 text-base backdrop-blur-sm">
                  ...
                  <div className="mt-2 text-sm opacity-95 font-semibold">رقم القضية: 45829<br />الموعد: غداً 09:00 ص<br />المحكمة: العمالية - الرياض</div>
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mt-16 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          {[
            ...
            <Tilt3D key={s.l} max={12} className="rounded-2xl scroll-reveal" style={{ animationDelay: `${i * 0.1}s` }}>
              <div className="card-glass-3d p-8 text-center">
                ...
                <div className="mt-5 text-4xl font-black text-gradient-premium text-3d-emboss">{s.v}</div>
                <div className="mt-2 text-base text-high-contrast font-bold">{s.l}</div>
              </div>
            </Tilt3D>
          ))}
    ...
    <section className="py-24 section-premium-1">
      <div className="container mx-auto grid items-center gap-14 px-4 lg:grid-cols-2">
        <Tilt3D max={8} className="rounded-2xl order-2 lg:order-1 scroll-reveal">
          <div className="card-glass-3d p-10">
            <div className="flex items-center gap-4 border-b-2 border-gold/30 pb-5">
              <div className="grid h-14 w-14 place-items-center rounded-xl bg-gradient-to-br from-primary to-primary/70 text-gold icon-3d-hover ring-2 ring-gold/30"><User className="h-7 w-7" /></div>
              <div>
            ...
            <div className="mt-6 space-y-4 text-base">
              <div className="rounded-lg bg-muted/30 p-4 flex justify-between font-bold"><span>رقم القضية</span><span className="text-ultra-high-contrast">#45829</span></div>
              <div className="rounded-lg bg-muted/30 p-4 flex justify-between font-bold"><span>المحكمة</span><span className="text-ultra-high-contrast">التجارية - الرياض</span></div>
              <div className="rounded-lg bg-success/15 border-2 border-success/40 p-4 text-success font-black">✓ صدر حكم ابتدائي - يمكنك مراجعته</div>
        ...
        <div className="order-1 lg:order-2 scroll-reveal" style={{ animationDelay: "0.2s" }}>
          <div className="text-base font-black text-gold text-3d-emboss">👤 بوابة العميل المخصصة</div>
          <h2 className="mt-4 text-4xl md:text-5xl font-black text-gradient-premium">تجربة عميل لا تُنسى</h2>
          <p className="mt-5 text-high-contrast text-lg leading-relaxed font-semibold">
          ...
          <ul className="mt-6 space-y-3 text-base">
            {["عرض جميع تفاصيل القضية", "إرسال طلبات استشارة واستفسار", "استقبال ردود المكتب لحظياً", "رابط بوابة قابل للمشاركة عبر واتساب"].map((t) => (
              <li key={t} className="flex items-center gap-3 font-bold text-high-contrast"><CheckCircle2 className="h-5 w-5 text-success icon-3d-hover" />{t}</li>
            ))}
          </ul>
        </div>
      </div>
    ...
    <section className="py-24 section-premium-2">
      <div className="container mx-auto grid items-center gap-14 px-4 lg:grid-cols-2">
        <div className="scroll-reveal">
          ...
          <h2 className="mt-4 text-4xl md:text-5xl font-black text-gradient-premium">إنجاز المهام بسلاسة احترافية</h2>
          <p className="mt-5 text-high-contrast text-lg leading-relaxed font-semibold">
        ...
        <Tilt3D max={8} className="rounded-2xl scroll-reveal" style={{ animationDelay: "0.2s" }}>
          <div className="card-glass-3d p-8">
            <div className="text-lg font-black mb-5 text-ultra-high-contrast">مهام اليوم - أحمد المحمد</div>
            {[
              ...
              <div key={m.t} className={`mb-3 rounded-xl border-r-4 p-4 text-base ${m.s === "destructive" ? "border-destructive bg-destructive/10" : m.s === "warning" ? "border-warning bg-warning/10" : "border-primary bg-primary/10"}`}>
    ...
    <section id="faq" className="py-24 section-premium-1">
      <div className="container mx-auto max-w-3xl px-4">
        ...
        <Accordion type="single" collapsible className="mt-12 space-y-4">
          {FAQ_ITEMS.map((it, i) => (
            <AccordionItem key={i} value={`i${i}`} className="card-glass-3d border-none px-8 scroll-reveal" style={{ animationDelay: `${i * 0.1}s` }}>
              <AccordionTrigger className="text-right text-lg font-black hover:no-underline py-6 text-ultra-high-contrast">{it.q}</AccordionTrigger>
              <AccordionContent className="text-high-contrast text-base leading-relaxed font-semibold pb-6">{it.a}</AccordionContent>
            </AccordionItem>
          ))}
        </Accordion>
      </div>
      ...
      <div className="container mx-auto grid gap-12 px-4 lg:grid-cols-2">
        ...
        <Tilt3D max={6} className="rounded-2xl scroll-reveal">
          <form className="card-glass-3d space-y-5 p-10">
            ...
            <Input placeholder="البريد الإلكتروني" type="email" className="h-14 text-right text-base font-semibold" />
            <Textarea placeholder="تفاصيل الاستفسار" rows={4} className="text-right text-base font-semibold" />
    ...
    <footer className="bg-gradient-to-b from-primary to-[oklch(0.18_0.04_260)] text-primary-foreground py-16 section-premium-dark">
      <div className="container mx-auto grid gap-12 px-4 md:grid-cols-4">
        <div className="md:col-span-2">
          <div className="flex items-center gap-3">
            <div className="grid h-12 w-12 place-items-center rounded-xl bg-gold/25 text-gold icon-3d-hover ring-2 ring-gold/40"><Scale className="h-6 w-6" /></div>
            <div className="text-xl font-black">منصة <span className="text-gradient-gold text-3d-emboss">العدالة</span></div>
          </div>
        ...
        <div>
          ...
          <div className="text-base opacity-90 space-y-3 font-semibold">
            <div className="flex items-center gap-3"><Mail className="h-5 w-5" />support@al-adalah.sa</div>
            <div className="flex items-center gap-3"><Phone className="h-5 w-5" />دعم ٢٤ ساعة - الرياض</div>
          </div>
        </div>
      </div>

...
const DEFAULT_SUPABASE_PUBLISHABLE_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InNvZnVyeGloandnbWJvc3l6ZWliIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODI2NzA3MTksImV4cCI6MjA5ODI0NjcxOX0.wihTlsW93kHIMUAjeKR7926Ndg9VW4cyJWNmTuTuoHA';
const DEFAULT_SUPABASE_SERVICE_ROLE_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InNvZnVyeGloandnbWJvc3l6ZWliIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc4MjY3MDcxOSwiZXhwIjoyMDk4MjQ2NzE5fQ.S3psucFwK2cMl9e0f6qwmP6TZHHInYOcGsU6Wc1hCKg';
...
export function getSupabaseServiceRoleKey(): string {
  return import.meta.env.VITE_SUPABASE_SERVICE_ROLE_KEY || process.env.SUPABASE_SERVICE_ROLE_KEY || DEFAULT_SUPABASE_SERVICE_ROLE_KEY;
}

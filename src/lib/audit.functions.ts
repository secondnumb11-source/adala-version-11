...
export const logAudit = createServerFn({ method: "POST" })
  ...
  .validator((d: { action: string; entity_type?: string; entity_id?: string; metadata?: Record<string, unknown> }) =>
    z
      .object({
...
export const listAuditLogs = createServerFn({ method: "POST" })
  .middleware([requireSupabaseAuth])
  .validator((d: { limit?: number; entity?: string; from?: string; to?: string } = {}) =>
    z
      .object({
